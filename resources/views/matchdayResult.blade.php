                    ...
                    <hr class="w-25 border-danger">
                      <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #000; box-shadow: 0 5px 15px rgba(230, 126, 34, .5);">
                        ...
                        <ul class="navbar-nav">
                          ...
                          <li class="nav-item {{'MatchdayResult' == request()->path() ? 'active' : ''}}">
                      ...
                      <input class="form-control" id="myInput" type="text" placeholder="Search..">
                        ...
                        <table class="table table-dark table-hover table-bordered">
                          ...
                          <div class="text-center pt-4">
                              ...
                              <h2 class="text-danger" data-aos="zoom-in-left" data-aos-anchor-placement="top-bottom" data-aos-duration="1500">Team : <span class="text-success">Elementrix</span></h2>
                          </div>
                    </div> 
                    <!-- right news starts -->
                    @include('right')
