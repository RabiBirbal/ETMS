                    ...
                    <table class="table table-striped table-hover projects">
                      ...
                      <tbody id="myTable">
                        ...
                        <tr>
                          ...
                          <td>{{$data['email']}} </td>
                          <td><form>
                            <textarea rows="3" style="width: 100%" readonly>{{$data['feedback']}}</textarea>
                          </form></td>
                          <td>
                            <a href="{{'delete_feedback/'.$data['id']}}" onclick="return confirm('Are you sure want to delete?')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
