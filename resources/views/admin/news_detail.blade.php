                    ...
                    <table class="table table-striped table-hover projects">
                      ...
                      <tbody id="myTable">
                        ...
                        <tr>
                          ...
                          <td>{{$data['title']}} </td>
                          <td><form>
                            <textarea style="width: 100%" rows="4" readonly>{{$data['content']}}</textarea>
                          </form></td>
                          <td>
                            <a href="{{'edit_news/'.$data['id']}}" class="btn btn-info btn-xs" data-target="#userLoginModal" data-toggle="modal"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="{{'delete_news/'.$data['id']}}" onclick="return confirm('Are you sure want to delete?')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content" style="background-color: #1e272e;">
                            ...
                            <div class="modal-header">
                              <h2 class="text-center text-light">Edit News</h2>
                                <button class="bg-dark text-light" type="submit" data-dismiss="modal" style="cursor: pointer;">&times;</button>
                            </div>

                            <!-- Modal body -->
                            <div class="modal-body">
                              <form action="edit_news" method="post" enctype="multipart/form-data" class="was-validated">
                                @csrf
                                @foreach($news as $data)
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea class="form-control" rows="5" id="content" name="content" placeholder="Enter Content" required>{{$data['content']}}</textarea> 
                                  <!-- <div class="valid-feedback">Valid.</div> -->
                                  <div class="invalid-feedback">Please fill out this field.</div>
                                </div>
                            </div>
