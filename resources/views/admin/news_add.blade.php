              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <!-- start project list -->
                    <form action="admin/news_add" method="post" onsubmit="return alert('News added Successfully!!')" class="was-validated p-2">
                      @csrf
                      ...
                      <div class="form-group col-lg-12">
                        ...
                        <textarea class="form-control" rows="15" id="content" name="content" placeholder="Enter Content" required></textarea> 
                        <!-- <div class="valid-feedback">Valid.</div> -->
                        <div class="invalid-feedback">Please fill out this field.</div>
                      </div>
                    </div> <!-- row ends --> 
                      <div class="text-center pt-4">
                        <button type="submit" onclick="return confirm('Are you sure want to add news?')" class="btn btn-primary">Publish</button>
                      </div>
                    </form>  
                    <!-- end project list -->
