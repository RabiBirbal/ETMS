            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form action="admin/schedule_add" method="post" onsubmit="return alert('Schedule added Successfully!!')" class="was-validated p-2">
                      @csrf
                    <div class="row">
                      ...
                      <div class="text-center p-4">
                          <button type="submit" onclick="return confirm('Are you sure want to add new schedule?')" class="btn btn-primary">Add Now</button>
                      </div>
                    </form>       
                  </div>
                </div>
