                    ...
                    <table class="table table-striped table-hover projects">
                      <thead class="thead-dark">
                        <tr>
                          ...
                          <th style="width: 25%">Profile Picture</th>
                      ...
                      <tbody id="myTable">
                        ...
                        <tr>
                          ...
                          <td><img src="{{asset('upload/images/'.$user->profile_pic)}}" width="100%"></td>
                          <td>{{$user['username']}} </td>
                          <td>{{$user['email']}} </td>
                          <td>{{$user['address']}} </td>
                          <td>{{$user['phone']}} </td>
                          ...
                          <td>
                            <a href="{{'delete_user/'.$user['id']}}"class="btn btn-danger btn-xs" onclick="return confirm('Are you sure want to delete?')"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
