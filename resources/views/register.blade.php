      ...
      <div class="container-fluid p-sm-3 mainpage">
          <div class="row">
                <div class="col-lg-9 col-md-8 col-sm-12 box">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" onsubmit="return alert('Registration Successfull!!')" class="was-validated p-2">
                      @csrf
                    <div class="row">
                      ...
                      <div class="form-group col-lg-6">
                        <label for="profilePic">Profile Picture :</label>
                          <input type="file" id="file-ip-1" accept="image/*" class="form-control-file border text-white" onchange="showPreview(event);" name="profilePic" required="">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input type="password" class="form-control" id="pswd" value="{{old('pswd')}}" placeholder="Enter Password" name="pswd" required>
                        <!-- <div class="valid-feedback">Valid.</div> -->
                        <div class="invalid-feedback">Please fill out this field.</div>
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <input type="password" class="form-control" id="cpswd" value="{{old('cpswd')}}" placeholder="Enter Password" name="cpswd" required>
                        <!-- <div class="valid-feedback">Valid.</div> -->
                        <div class="invalid-feedback">Please fill out this field.</div>
                      ...
                      <div class="form-group form-check col-lg-12 pl-4">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" name="remember" required> I agree all the <a href="" data-target="#userRegisterModal" data-toggle="modal">terms and conditions.</a> 
                          <div class="valid-feedback">Valid.</div>
                    ...
                    <!-- modal ends -->    
                      ...
                      <div class="text-center p-4">
                          <button type="submit" onclick="return confirm('Are you sure want to register?')" class="btn btn-primary">Submit</button>
                      </div>
                    </form>                                  
                </div> 
                    <!-- right news starts -->
        ...
        <script type="text/javascript" src="JavaScript/validateRegister.js">
        </script>
    </body>
</html>
